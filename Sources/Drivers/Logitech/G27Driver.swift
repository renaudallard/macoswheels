...
public final class G27Driver: DeviceDriver, @unchecked Sendable {

    public static let displayName = "Logitech G27"

    public static let supportedIDs: [WheelIdentity] = [
        WheelIdentity(vendorID: LGOpcode.logitechVID, productID: LGPID.g27,
                      model: G27Driver.displayName, role: .wheelBase),
    ]
