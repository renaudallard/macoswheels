...
public final class G920Driver: DeviceDriver, @unchecked Sendable {

    public static let displayName = "Logitech G920"

    public static let supportedIDs: [WheelIdentity] = [
        WheelIdentity(vendorID: LGOpcode.logitechVID, productID: LGPID.g920,
                      model: G920Driver.displayName, role: .wheelBase),
    ]
